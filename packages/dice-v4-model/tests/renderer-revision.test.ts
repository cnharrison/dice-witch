...
describe("V4 renderer revision policies", () => {
  ...
  it("adds resolved authored views in r20 without changing r19", () => {
    ...
    const revision30 = rendererRevisionPolicyV4("canvaskit-v4-r30");
    expect(revision30).toEqual({
      ...revision29,
    ...
    const revision33 = rendererRevisionPolicyV4("canvaskit-v4-r33");
    expect(revision33).toEqual({
      ...revision32,
    ...
    const revision37 = rendererRevisionPolicyV4("canvaskit-v4-r37");
    expect(revision37).toEqual({
      ...revision36,
      r37Fonts: true,
    });
    ...
    const revision39 = rendererRevisionPolicyV4("canvaskit-v4-r39");
    expect(revision39).toEqual({
      ...revision38,
      outlineContrast: "adaptive-r39",
    });
    expect(rendererRevisionPolicyV4("canvaskit-v4-r40")).toEqual({
      ...revision39,
  ...
  it("rejects unknown revisions instead of inferring a policy", () => {
    expect(() =>
      rendererRevisionPolicyV4(
        "canvaskit-v4-r41" as RendererRevisionV4,
      ),
