...
import {
  ...
  type AppearanceResolutionSeedPolicyV3,
...
function appearanceSeedPolicyV3(
  ...
  if (
    ...
    rendererRevision === ROLL_RENDERER_REVISION_R42_V4
  ) {
  ...
  if (rendererRevision === ROLL_RENDERER_REVISION_R33_V4) {
    return "property-streams-r33";
  }
  if (rendererRevision === ROLL_RENDERER_REVISION_R32_V4) {
    return "property-streams-r32";
  }
  if (rendererRevision === ROLL_RENDERER_REVISION_R31_V4) {
    return "property-streams-r31";
  }
  if (rendererRevision === ROLL_RENDERER_REVISION_R30_V4) {
    return "property-streams-r30";
  }
  if (rendererRevision === ROLL_RENDERER_REVISION_R29_V4) {
    return "property-streams-r29";
  }
  if (rendererRevision === ROLL_RENDERER_REVISION_R28_V4) {
    return "property-streams-r28";
  }
  if (rendererRevision === ROLL_RENDERER_REVISION_R27_V4) {
    return "property-streams-r27";
  }
  return rendererRevision === ROLL_RENDERER_REVISION_R26_V4
...
export const ROLL_RENDERER_REVISION_R25_V4 = "canvaskit-v4-r25" as const;
export const ROLL_RENDERER_REVISION_R26_V4 = "canvaskit-v4-r26" as const;
export const ROLL_RENDERER_REVISION_R27_V4 = "canvaskit-v4-r27" as const;
export const ROLL_RENDERER_REVISION_R28_V4 = "canvaskit-v4-r28" as const;
export const ROLL_RENDERER_REVISION_R29_V4 = "canvaskit-v4-r29" as const;
export const ROLL_RENDERER_REVISION_R30_V4 = "canvaskit-v4-r30" as const;
export const ROLL_RENDERER_REVISION_R31_V4 = "canvaskit-v4-r31" as const;
...
export const ROLL_RENDERER_REVISION_R42_V4 = "canvaskit-v4-r42" as const;
...
function buildRollRenderRequestForRevisionV4(
  ...
  rendererRevision:
    ...
    | typeof ROLL_RENDERER_REVISION_R25_V4
    | typeof ROLL_RENDERER_REVISION_R26_V4
    | typeof ROLL_RENDERER_REVISION_R27_V4
    | typeof ROLL_RENDERER_REVISION_R28_V4
    | typeof ROLL_RENDERER_REVISION_R29_V4
    | typeof ROLL_RENDERER_REVISION_R30_V4
    ...
    | typeof ROLL_RENDERER_REVISION_R42_V4,
): RenderRequestV4 {
  validateRenderSeed(renderSeed);
  const groups = renderableRollOutcomes(result).map(
    ({ outcome, outcomeIndex }) => {
...
export function buildRollRenderRequestR22V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR23V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR25V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR26V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR27V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR28V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR29V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR30V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR31V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR32V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR33V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR34V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR38V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
...
export function buildRollRenderRequestR42V4(
  result: RollExecutionResult,
  renderSeed: number,
  effectiveAppearance: EffectiveAppearanceV4,
): RenderRequestV4 {
