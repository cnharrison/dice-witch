...
describe("appearance preview", () => {
  ...
  it("routes V4 previews through the configured immutable policy", () => {
    ...
    expect(
      buildAppearancePreviewRenderRequestForPolicyV4(input, "r33")
        .rendererRevision,
    ).toBe("canvaskit-v4-r33");
    expect(
      buildAppearancePreviewRenderRequestForPolicyV4(input, "r34")
        .rendererRevision,
    ).toBe("canvaskit-v4-r34");
    expect(
    ...
    expect(
      buildAppearancePreviewRenderRequestForPolicyV4(input, "r39")
        .rendererRevision,
    ).toBe("canvaskit-v4-r39");
    expect(
      buildAppearancePreviewRenderRequestForPolicyV4(input, "r40")
        .rendererRevision,
    ).toBe("canvaskit-v4-r40");
    expect(
