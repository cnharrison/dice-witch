const generateDPercent90 = (
  ...
  <g>
      <text transform="translate(170.31 210.62)" style="font-family:Poppins-Bold,Poppins;font-weight:700;font-size:96.29px">90</text>
      <text transform="matrix(.59 .3 -.31 .79 56.63 169.1)" style="font-size:67.49px;font-family:Poppins-Bold,Poppins;font-weight:700">30</text>
      <text transform="matrix(.72 -.34 .51 .86 349.72 193.62)" style="font-size:59.74px;font-family:Poppins-Bold,Poppins;font-weight:700">70</text>
      ...
      <text transform="matrix(-.96 0 -.3 -.96 195.4 287.03)" style="font-size:77.36px;font-family:Poppins-Bold,Poppins;font-weight:700">40</text>
  </g>
</svg>
  `;

module.exports = generateDPercent90;
