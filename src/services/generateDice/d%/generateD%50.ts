...
<svg viewBox="0 0 ${viewBoxW} ${viewBoxH}">
  ...
  <g>
      <text transform="translate(170.31 210.62)" style="font-family:Poppins-Bold,Poppins;font-weight:700;font-size:96.29px">50</text>
      <text transform="matrix(.59 .3 -.31 .79 64.63 172.1)" style="font-size:67.49px;font-family:Poppins-Bold,Poppins;font-weight:700">10</text>
      <text transform="matrix(.72 -.34 .51 .86 346.72 194.62)" style="font-size:59.74px;font-family:Poppins-Bold,Poppins;font-weight:700">30</text>
      <text transform="matrix(-.97 0 .26 -.97 363.49 287.06)" style="font-size:76.51px;font-family:Poppins-Bold,Poppins;font-weight:700">60</text>
      <text transform="matrix(-.96 0 -.3 -.96 192.4 287.03)" style="font-size:77.36px;font-family:Poppins-Bold,Poppins;font-weight:700">00</text>
  </g>
</svg>
  `;

export default generateDPercent50;
